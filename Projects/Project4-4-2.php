...
if(isset($_POST['submit']))
{
    ...
    if($_POST['resetby'] == "id")
    $sql="SELECT * FROM Students WHERE id='".$_POST['idORemail']."';";
    
  	 else if($_POST['resetby'] == "email")
    $sql="SELECT * FROM Students WHERE email='".$_POST['idORemail']."';";
    ...
    if($row)//found the id or email
     {
        ...
        $txt = "Your login id is ".$row[0].".\r\n\r\n".
                ...
                "http://khaledasad.altervista.org/Project4.php?id=".$row[0].
                "&sand=".md5($row[1]);
